...
import { FloatingInput } from "@/components/features/auth/AuthComponents";
      ...
      <div className="hidden lg:flex lg:w-[60%] relative overflow-hidden bg-black outline-none border-r border-gray-100">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-between p-16">
          ...
          <div className="max-w-xl">
            ...
            >
              Great food is always a good idea.
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Join our community and discover over 500+ local favorites delivered straight to your door.
            </motion.p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[40%] flex flex-col items-center justify-center p-8 md:p-12 lg:p-16 relative bg-white">
        ...
        >
          ...
          <div className="mb-10 text-center lg:text-left">
            ...
            <p className="text-gray-500 font-medium tracking-tight">Access your account to order from your favorites.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-2">
              ...
              {!isMagicLink ? (
                ...
                >
                  ...
                  <div className="flex justify-end mb-8 mt-1">
                    <Link href="#" className="text-sm font-bold text-brand-orange hover:text-brand-orange-hover transition-colors">
                      Forgot Password?
                    </Link>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="pb-8"
                >
                  <div className="p-4 bg-orange-50 border border-orange-100 rounded-2xl flex gap-3 text-brand-orange mb-4">
                    <AlertCircle size={20} className="shrink-0" />
                    <p className="text-sm font-bold leading-tight">We'll send a unique login link directly to your inbox for password-less entry.</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <Button 
              type="submit"
              disabled={isLoading || (!email || (!password && !isMagicLink))}
          ...
          <div className="mt-6 text-center">
            <button onClick={() => setIsMagicLink(!isMagicLink)} className="text-sm font-bold text-gray-400 hover:text-gray-600 transition-colors">
              {isMagicLink ? "Sign in with password instead" : "Sign in with a magic link instead"}
            </button>
          </div>

          <div className="mt-12 text-center text-sm">
            <span className="text-gray-500 font-medium tracking-tight">Don't have an account? </span>
            <Link href="/auth/signup" className="text-brand-orange font-bold hover:text-brand-orange-hover transition-colors">
              Sign up for free
            </Link>
          </div>
        </motion.div>
